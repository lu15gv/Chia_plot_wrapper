...
### 5.- Temporal directory
		...
		TEMPORAL_DIRECTORY_LIST=( '/ssd1/' '/ssd1/' '/ssd1/' '/ssd1/' '/ssd1/' '/ssd1/' '/ssd1/' '/ssd2/' '/ssd2/' '/ssd2/' '/ssd2/' '/ssd2/' '/ssd2/' '/ssd2/' )

### 6.- Final directory
		FINAL_DIRECTORY="I:/"
		# This is optional, only uncomment it if you want to choice different directories for each parallel chia ploter. List size must match PARALLEL
		FINAL_DIRECTORY_LIST=( '/hdd1/' '/hdd1/' '/hdd1/' '/hdd1/' '/hdd1/' '/hdd1/' '/hdd1/' '/hdd2/' '/hdd2/' '/hdd2/' '/hdd2/' '/hdd2/' '/hdd2/' '/hdd2/' )
